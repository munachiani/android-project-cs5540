...
public class ChatListAdapter extends BaseAdapter{
    ...
    private void setChatRowAppearance(boolean isItMe, ViewHolder holder){
        if(isItMe){
            ...
            holder.authorName.setTextColor(Color.GRAY);
            holder.body.setBackgroundResource(R.drawable.btn_default_normal_disable_gray);
        } else {

            holder.params.gravity = Gravity.START;
            holder.authorName.setTextColor(Color.GRAY);
            holder.body.setBackgroundResource(R.drawable.btn_default_normal_red);
